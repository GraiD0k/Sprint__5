...
class TestRegistration:
    def test_registration_success(self,driver):
        ...
        driver.find_element(*Locators.EMAIL_FOR_REGISTRATION).send_keys('AlekseyAlekseev_17214@yandex.ru')
        driver.find_element(*Locators.PASSWORD_FOR_REGISTRATION).send_keys('11122253')
    ...
    def test_registration_incorrect_password(self, driver):
        ...
        driver.find_element(*Locators.EMAIL_FOR_REGISTRATION).send_keys('123@qweq.re')
