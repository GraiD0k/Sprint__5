...
class TestConstructorPage:
    def test_click_to_sauces_in_constructor(self,driver):
        ...
        assert driver.find_element(*Locators.LINK_SAUCES_CONSTRUCTOR).is_displayed()
    ...
    def test_click_to_buns_in_constructor(self,driver):
        ...
        assert driver.find_element(*Locators.LINK_BUNS_CONSTRUCTOR).is_displayed()
    ...
    def test_click_to_filling_in_constructor(self,driver):
        ...
        assert driver.find_element(*Locators.LINK_FILLING_CONSTRUCTOR).is_displayed()